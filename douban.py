...
class LoginClass(QtWidgets.QDialog):
    def __init__(self):
        ...
        self.idcodePic.captchaClicked.connect(self.getCaptchaInThread)
...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.playButton = QtWidgets.QPushButton("(&P)play")
        ...
        minimizeAction = QtWidgets.QAction('min', self,triggered=self.hide)
        restoreAction = QtWidgets.QAction('normal', self,triggered=self.showNormal)
